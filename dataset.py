        ...
        for seq_dir in seq_dirs:
            ...
            for ann_file in sorted(os.listdir(ann_dir)):
                ...
                for i in range(1, len(ann)):
                    ...
                    x_prev, y_prev = x_mm_prev, y_mm_prev # convert mm to pixel coords (assuming 1mm = 1 pixel for now, adjust if needed)
                    x_curr, y_curr = x_mm_curr, y_mm_curr # convert mm to pixel coords (assuming 1mm = 1 pixel for now, adjust if needed)
